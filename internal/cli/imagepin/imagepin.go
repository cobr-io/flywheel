...
// it if absent. On a pull failure for the unmodified default ghcr.io ref it
// returns the option-(c) override guidance.
...
func inLocalDocker(ctx context.Context, ref string) bool {
